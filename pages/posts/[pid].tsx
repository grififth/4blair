      ...
      {post && (
        <div className="w-2/3 p-4 flex flex-col items-center gap-4">
          <div className="w-full p-4 bg-lightforeground dark:bg-darkforeground rounded-lg shadow-md flex flex-col gap-4 border-1 border-border">
            <h1 className="text-3xl font-bold text-lightaccent dark:text-darkaccent">
              {post && post["title"]}
            </h1>
          ...
          {comments && (
            <div className="w-full flex flex-col items-center gap-2">
              <div className="w-full flex flex-col gap-4 p-4 bg-lightforeground dark:bg-darkforeground rounded-lg shadow-md border-1 border-border">
                <h1 className="text-xl">New Comment</h1>
                {replyToComment && (
                  <div className="flex w-full text-md text-lightaccent dark:text-darkaccent items-center justify-between">
                ...
                {statusMessage && (
                  <div className="w-full text-md text-lightaccent dark:text-darkaccent">
                    {statusMessage}
                  </div>
                )}
                <button
                  className="w-full p-2 bg-lightaccent dark:bg-darkaccent rounded-lg shadow-md border-1 border-border"
                  onClick={() => postComment()}
                >
                  Submit
                </button>
              ...
              {!isLoading && !isFetchingNextPage && hasNextPage && (
                <button
                  className="w-1/2 p-4 bg-lightaccent dark:bg-darkaccent rounded-lg shadow-md flex flex-col border-1 border-border"
